...
void MenuButton::initialize(float x_, float y_, int type_, std::string str) {
    x = x_, y = y_, type = type_;
    label = str;
    img = LoadImage("../../assets/image/button.jpg");
    button = LoadTextureFromImage(img);
    UnloadImage(img);

    img = LoadImage("../../assets/image/banner.png");
...
MenuButton::MenuButton(float x_, float y_, int type_, std::string str) {
    ...
    img = LoadImage("../../assets/image/moveleft.png");
    MoveLeft = LoadTextureFromImage(img);
    UnloadImage(img);

    img = LoadImage("../../assets/image/moveright.png");
    ...
    img = LoadImage("../../assets/image/volume0.png");
    Volume.push_back(LoadTextureFromImage(img));
    UnloadImage(img);

    img = LoadImage("../../assets/image/volume1.jpg");
    Volume.push_back(LoadTextureFromImage(img));
    UnloadImage(img);

    img = LoadImage("../../assets/image/volume2.jpg");
    Volume.push_back(LoadTextureFromImage(img));
    UnloadImage(img);

    img = LoadImage("../../assets/image/volume3.jpg");
    Volume.push_back(LoadTextureFromImage(img));
    UnloadImage(img);

    img = LoadImage("../../assets/image/volume4.jpg");
    Volume.push_back(LoadTextureFromImage(img));
    UnloadImage(img);

    img = LoadImage("../../assets/image/volume5.jpg");
    Volume.push_back(LoadTextureFromImage(img));
    UnloadImage(img);

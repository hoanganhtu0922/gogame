...
IMG::IMG() {
    Image img = LoadImage("../../assets/image/black.png");
    ...
    Image undo_button = LoadImage("../../assets/image/undo.jpg");
    ...
    img = LoadImage("../../assets/image/redo.png");
    ImageFormat(&img, PIXELFORMAT_UNCOMPRESSED_R8G8B8A8);
    RemoveBlack(img);
    RedoButton = LoadTextureFromImage(img);
    UnloadImage(img);

    img = LoadImage("../../assets/image/skip.png");
    ImageFormat(&img, PIXELFORMAT_UNCOMPRESSED_R8G8B8A8);
    RemoveBlack(img);
    SkipButton = LoadTextureFromImage(img);
    UnloadImage(img);

    img = LoadImage("../../assets/image/exit.jpg");
    ImageFormat(&img, PIXELFORMAT_UNCOMPRESSED_R8G8B8A8);
    RemoveBlack(img);
    ExitButton = LoadTextureFromImage(img);
    UnloadImage(img);

    img = LoadImage("../../assets/image/gg.png");
    ImageFormat(&img, PIXELFORMAT_UNCOMPRESSED_R8G8B8A8);
    RemoveBlack(img);
